...
// private QueueStack<String> q1;
// private QueueStack<Integer> q2;
// private QueueStack<Double> q3;
...
// }
// q2 = new QueueStack<>();
// q3 = new QueueStack<>(new Double[] { 1.1, 2.2, 3.3, 4.4 });
// }
...
// String[] array = null;
// assertEquals(0, new QueueStack<String>(array).getSize());
// }

// @Test
// void testQueueQueueOfT() {
// setUp();
// QueueStack<String> nullQ = null;
// QueueStack<String> copy = new QueueStack<>(nullQ);
// assertEquals(0, copy.getSize());
// copy = new QueueStack<>(q1);
...
// q1.dequeue();
// }
// QueueStack<String> test = new QueueStack<>();
...
// QueueStack<Double> test2 = new QueueStack<>(new Double[] { 1.1, 2.2, 3.2, 4.4
// });
...
// setUp();
// QueueStack<String> q = new QueueStack<>();
// q.enqueue("A");
// q.enqueue("B");
// q.enqueue("C");
// assertEquals("C B A \n", q.reverseQueue());
